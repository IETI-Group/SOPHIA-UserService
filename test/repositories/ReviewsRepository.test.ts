...
describe('ReviewsRepository', () => {
  ...
  describe('getInstructorReviews', () => {
    it('should return paginated reviews for an instructor', async () => {
      ...
      const result = await reviewsRepository.getInstructorReviews(instructorId, 1, 10);

      expect(result.success).toBe(true);
      expect(result.data).toHaveLength(2);
      expect(result.data?.[0].reviewedId).toBe(instructorId);
      expect(result.data?.[1].reviewedId).toBe(instructorId);
  ...
  describe('getCourseReviews', () => {
    it('should return paginated reviews for a course', async () => {
      ...
      const result = await reviewsRepository.getCourseReviews(courseId, 1, 10);

      expect(result.success).toBe(true);
      expect(result.data).toHaveLength(2);
      expect(result.data?.[0].reviewedId).toBe(courseId);
